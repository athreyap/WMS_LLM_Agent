                ...
                with st.spinner("🔍 Analyzing..."):
                    try:
                        ...
                        response = openai.chat.completions.create(
                            model="gpt-4o-mini",
                            messages=[
                                {"role": "system", "content": "You are a professional portfolio analyst. Provide a concise health check in 2-3 sentences with specific insights about performance, risk, and recommendations. Use emojis and be encouraging but realistic."},
                ...
                with st.spinner("💭 Thinking..."):
                    try:
                        ...
                        response = openai.chat.completions.create(
                            model="gpt-4o-mini",
                            messages=[
                                {"role": "system", "content": "You are a smart portfolio advisor. Give 2-3 specific, actionable tips based on the portfolio data. Be practical and include emojis. Focus on optimization opportunities."},
                                {"role": "user", "content": f"{portfolio_summary}"}
                            ],
                            temperature=0.7,
                            max_tokens=250
            ...
            with st.spinner("🤔 AI is thinking..."):
                try:
                    ...
                    response = openai.chat.completions.create(
                        model="gpt-4o-mini",
                        messages=[
                            {"role": "system", "content": "You are a helpful and knowledgeable portfolio assistant. Answer questions clearly and specifically based on the portfolio data and any uploaded documents provided. Use emojis appropriately and be encouraging. Keep responses concise but informative."},
                    ...
                    st.markdown(f'<div class="ai-response-box"><strong>🤖 AI Response:</strong><br><br>{ai_response}</div>', unsafe_allow_html=True)
